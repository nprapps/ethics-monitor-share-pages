...
PROJECT_SLUG = 'ethics-monitor-share-pages'

# Project name to be used in file paths
PROJECT_FILENAME = 'ethics_monitor_share_pages'

# The name of the repository containing the source
REPOSITORY_NAME = 'ethics-monitor-share-pages'
...
ASSETS_SLUG = 'ethics-monitor-share-pages'
